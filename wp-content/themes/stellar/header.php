...
<body>
    ...
    <header>
        <div class="header">
            <div class="header__wrapper max-w-[1200px] justify-items-start w-full mx-auto flex justify-between sm:gap-3 pl-20 pr-32 py-5">
                ...
                <div class="header__nav-menu  ml-14 mr-24 hidden md:block">
                    <nav class="nav-menu flex-row justify-between 	">
