<div
    class="flex flex-col mx-auto text-center lg:max-w-[1530px] bg-[#292929] px-[24px] md:px-[80px] lg:px-[96px] pb-[44px]">
    <div class="h-[112px] bg-[#A87FF3] mt-[-48px] rounded-[16px] relative flex flex-row mb-[48px]">
        ...
        <div>
            <p class="text-[10px] md:text-[22px] md:font-bold text-white py-[26px] pr-[80px] font-[Gotham]">Thanks for
                visit my website
                If you have any questions you can write me to any of my social networks, I am sure I will answer you.
            </p>


            <svg class="absolute w-[82px] top-0 right-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 125"
                fill="none">
