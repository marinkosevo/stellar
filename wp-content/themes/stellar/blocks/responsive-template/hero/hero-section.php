...
<div class="bg-white dark:bg-[#000] ">
    <div
        class="flex gap-[20px] font-['Anton'] flex-row bg-white lg:px-[100px] dark:bg-[#000] pt-[60px] max-w-[1530px] mx-auto">
                            ...
                            <div class="border p-[6px] border-[gray] rounded-md">
                                <a href="<?= $social['link']['url'] ?>" target="_blank">
                                    <?php if ($social['icon_light']): ?>
                                        <img class='flex dark:hidden w-[40px] h-[40px]' src="<?= $social['icon_light']['url'] ?>" alt="" srcset="">
                                    <?php endif;
                                    if ($social['icon_dark']): ?>
                                        <img class='hidden dark:flex w-[40px] h-[40px]' src="<?= $social['icon_dark']['url'] ?>" alt="" srcset="">
                                    <?php endif; ?>
                                </a>
                            </div>
                        <?php endforeach; ?>
