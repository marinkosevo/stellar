...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        if ($hero) : ?>
            <div id="hero" class="hero">
                <div class="max-w-[1280px] flex flex-col  w-full mx-auto hero__wrapper  py-[30px] gap-[60px] md:flex-row ">
                    <div class="left-side w-full md:w-4/6">
                        ...
                        <div class="gallery-wrapper hidden md:block">
                    ...
                    <div class="flex flex-col gap-5 mx:auto ">
                        <div class="w-[380px} flex flex-col gap-[16px] p-[24px] md:p-0">
                        ...
                        <div class="text-center flex flex-col gap-[23px] p-[24px] md:p-0">
                            ...
                            <div class="swiper mySwiper3">
                                ...
                                <div class="swiper-button-next ml-8"> <i class="fa-solid fa-circle-chevron-right text-[#133EBF] text-[40px]"></i> </div>
                                <div class="swiper-button-prev"> <i class="fa-solid fa-circle-chevron-left text-[#133EBF] text-[40px]"></i> </div>
                            </div>
                        </div>
                        <div class="flex w-full items-center p-[24px] md:p-0">
                            <div class="w-1/4 border-t border-gray-400 mr-auto"></div>
                            <h1 class="text-base text-[#586280]">Our Prices Can’t Be Beat</h1>
                            <div class="w-1/4 border-t border-gray-400 ml-auto"></div>
                        </div>
                        <div class="right-side__table p-[24px] md:p-0">
                            <div class="w-full text-[#586280]">
                                <div class="bg-[#F5F7FC] flex w-full">
                                    <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300 rounded-tl-xl"></div>

                                    <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300">Nectar</div>
                                    <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300">Comp1</div>
                                    <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300 rounded-tr-xl">Comp2</div>
                                </div>
                                <?php if ($table) : ?>
                                    <?php foreach ($rows as $row) : ?>
                                        <div class="flex ">
                                            <div class="w-1/4 pl-[8px] py-[12px] border-x-[1px] border-gray-300"><?= $row['item'] ?></div>
                                            <div class="w-1/4 pl-[8px] py-[12px] border-x-[1px] border-gray-300"><?= $row['nectar'] ?></div>
                                            <div class="w-1/4 pl-[8px] py-[12px] border-x-[1px] border-gray-300"><?= $row['comp1'] ?></div>
                                            <div class="w-1/4 pl-[8px] py-[12px] border-x-[1px] border-gray-300"><?= $row['comp2'] ?></div>
                                        </div>
                                    <?php endforeach; ?>
                                    <div class="flex ">
                                        <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300 rounded-bl-xl"><?= $total['item'] ?></div>
                                        <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300"><?= $total['nectar'] ?></div>
                                        <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300"><?= $total['comp1'] ?></div>
                                        <div class="w-1/4 pl-[8px] py-[12px] border-[1px] border-gray-300 rounded-br-xl"><?= $total['comp2'] ?></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <div id="image" class=" hidden md:flex flex-row bg-blue-100">
                <div class="w-1/2">
            ...
            if ($mobile) :
            ?>
                <div id="awards" class="w-full flex flex-col justify-between gap-[24px] py-[40px] md:hidden bg-blue-900">
                    <h1 class="text-center text-[28px] px-[24px] text-white">There’s no wrong side of this award-winning bed.</h1>
                    <div class="swiper mySwiper4 w-full justify-between gap-[40px flex flex-col]">
                        <div class="swiper-wrapper justify-between gap-[24px]">
                            <?php
                            foreach ($slides as $slide) :  ?>


                                <div class="swiper-slide w-9/12 p-[24px] flex-row">

                                    <img class="w-5/7 mx-auto py-[24px]"src="<?= $slide['cover']['url'] ?>">
                                    <h1 class="text-[20px] text-gray-900 "><?= $slide['heading'] ?></h1>
                                    <p class="text-[16px text-gray-700"><?= $slide['subheading'] ?></p>
                                </div>
                ...
                <div id="faq" class="w-full p-[24px] md:pt-[100px] pb-[168px]">
                    <?php
                    $faq = get_field('faq');
                    ...
                    <?php if ($questions) :
                        foreach ($questions as  $question) : ?>
                            <div class="faq-question flex flex-row  mx-auto border-b-[1px] border-gray-200 relative w-full md:w-3/12 p-[24px]">
                            ...
                            <div class="faq-answer hidden px-4 py-2 text-[#262B38] max-h-[500px] mx-auto w-full md:w-4/12 p-[24px] "><?= $question['answer'] ?></div>
                    <?php endforeach;
                    endif ?>
                </div>
            <?php endif; ?>
